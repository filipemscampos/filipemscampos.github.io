...
- remover os botões do menu à esquerda
- tirar o monte de imagens e posts do exemplo
- tirar as homes alternativas (q inclusive foram indexadas pelo Google)
- adicionar  a pasta dos _drafts (botar o post de MP lá)
- Compilar do jeito que tá pra botar no ar duma vez
- Esconder o email com o plugin
- decidir e botar na página o título, descrição e URL
- Variável de produção e de dev
